...
struct MI_STORE_REGISTER_MEM
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         Reserved_8                                       : __CODEGEN_BITFIELD( 8, 18)    ; 
...
struct PIPE_CONTROL
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         Reserved_62                                      : __CODEGEN_BITFIELD(30, 31)    ; 
...
struct MI_LOAD_REGISTER_IMM
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         Reserved_13                                      : __CODEGEN_BITFIELD(13, 18)    ; 
            __CODEGEN_UINT32         AddCSMMIOStartOffset                             : __CODEGEN_BITFIELD(19, 19)    ; 
