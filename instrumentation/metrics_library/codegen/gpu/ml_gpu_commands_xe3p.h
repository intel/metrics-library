...
struct PIPE_CONTROL
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         QueueDrainMode                                   : __CODEGEN_BITFIELD(12, 12)    ; 
            ...
            __CODEGEN_UINT32         PostSyncOperation                                : __CODEGEN_BITFIELD(14, 16)    ; 
    ...
    __CODEGEN_DebugType( PIPE_CONTROL )
    {
        ...
        __CODEGEN_DebugAttributeBool(   TheStructure.Common.QueueDrainMode                              , 12, 12 );
        ...
        __CODEGEN_DebugAttributeEnum(   TheStructure.Common.PostSyncOperation                           , 14, 16, POST_SYNC_OPERATION );
    ...
    typedef enum tagPOST_SYNC_OPERATION
    {
        ...
        POST_SYNC_OPERATION_WRITE_IMMEDIATE_DATA_32B                     = 4, 
    } POST_SYNC_OPERATION;
    ...
    __CODEGEN_DebugEnum( POST_SYNC_OPERATION )
    {
        ...
        __CODEGEN_DebugEnumValue( POST_SYNC_OPERATION_WRITE_IMMEDIATE_DATA_32B );
    }
    ...
    __CODEGEN_INLINE void SetQueueDrainMode( const __CODEGEN_BOOL value )
    {
        __CODEGEN_SET_MACRO( value );
        TheStructure.Common.QueueDrainMode = value;
    }

    __CODEGEN_INLINE __CODEGEN_BOOL GetQueueDrainMode( void ) const 
    {
        __CODEGEN_GET_MACRO();
