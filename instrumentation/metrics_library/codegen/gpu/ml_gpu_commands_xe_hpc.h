...
struct MI_STORE_REGISTER_MEM
{
    ...
    ///     Example: {Final Memory Write Address[64:2], 2'b00} = (Workload Partition
    ///     ID* Address Offset) + {Memory Write Address [64:2], 2'b00}
    ///     
...
struct PIPE_CONTROL
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         Reserved_10                                      : __CODEGEN_BITFIELD(10, 10)    ; ///< U1
            ...
            __CODEGEN_UINT32         Reserved_36                                      : __CODEGEN_BITFIELD( 4,  4)    ; ///< U1
            ...
            __CODEGEN_UINT32         Reserved_39                                      : __CODEGEN_BITFIELD( 7,  7)    ; ///< U1
            __CODEGEN_UINT32         NotifyEnable                                     : __CODEGEN_BITFIELD( 8,  8)    ; ///< U1
            __CODEGEN_UINT32         Reserved_41                                      : __CODEGEN_BITFIELD( 9,  9)    ; ///< U1
            ...
            __CODEGEN_UINT32         Reserved_44                                      : __CODEGEN_BITFIELD(12, 13)    ; ///< U2
            ...
            __CODEGEN_UINT32         Reserved_49                                      : __CODEGEN_BITFIELD(17, 17)    ; ///< U1
            __CODEGEN_UINT32         TLBInvalidate                                    : __CODEGEN_BITFIELD(18, 18)    ; ///< U1
            __CODEGEN_UINT32         Reserved_51                                      : __CODEGEN_BITFIELD(19, 19)    ; ///< U1
            ...
            __CODEGEN_UINT32         Reserved_60                                      : __CODEGEN_BITFIELD(28, 28)    ; ///< U1
            ...
            __CODEGEN_UINT32         Reserved_63                                      : __CODEGEN_BITFIELD(31, 31)    ; ///< U1
...
struct MI_STORE_DATA_IMM
{
    ...
    ///     WPARIDregister and the Address Offset gets programmed through
    ///     CS_MI_ADDRESS_OFFSET register.
    ///     Example for store dword/qword: {Final Memory Write Address[63:2], `b00}
