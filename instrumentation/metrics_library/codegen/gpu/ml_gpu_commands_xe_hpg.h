...
struct PIPE_CONTROL
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         HDCPipelineFlush                                 : __CODEGEN_BITFIELD( 9,  9)    ; ///< U1
            ...
            __CODEGEN_UINT32         Reserved_15                                      : __CODEGEN_BITFIELD(15, 15)    ; ///< U1
    ...
    __CODEGEN_DebugType( PIPE_CONTROL )
    {
        ...
        __CODEGEN_DebugAttributeUInt(   TheStructure.Common.HDCPipelineFlush                            ,  9,  9 );
    ...
    __CODEGEN_INLINE void Init( void )
    {
        ...
        //TheStructure.Common.PredicateEnable                        = 0x0;
        //TheStructure.Common.HDCPipelineFlush                       = 0x0;
    ...
    ///     state (MI_PREDICATE_RESULT[0])) bit is 0.
    ///       This command is un-conditionally NOOP'd when
    ///     MI_SET_PREDICATE_RESULT[0] is set.
    ///     
    ...
    /// @brief Read HDCPipelineFlush
    __CODEGEN_INLINE __CODEGEN_UINT32 GetHDCPipelineFlush( void ) const 
    {
        __CODEGEN_GET_MACRO();
