...
struct MI_STORE_REGISTER_MEM
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         Reserved_8                                       : __CODEGEN_BITFIELD( 8, 16)    ; 
...
struct PIPE_CONTROL
{
    ...
    union tagTheStructure
    {
        ...
        {
            __CODEGEN_UINT32         DWordLength                                      : __CODEGEN_BITFIELD( 0,  7)    ; 
            __CODEGEN_UINT32         Reserved_8                                       : __CODEGEN_BITFIELD( 8,  8)    ; 
            __CODEGEN_UINT32         HDCPipelineFlush                                 : __CODEGEN_BITFIELD( 9,  9)    ; 
            __CODEGEN_UINT32         Reserved_10                                      : __CODEGEN_BITFIELD(10, 15)    ; 
            ...
            __CODEGEN_UINT32         PSDSyncEnable                                    : __CODEGEN_BITFIELD(17, 17)    ; 
...
struct MI_STORE_DATA_IMM
{
    ...
    union tagTheStructure
    {
        struct tagCommon
        {
            ...
            __CODEGEN_UINT32         Reserved_11                                      : __CODEGEN_BITFIELD(11, 20)    ; 
