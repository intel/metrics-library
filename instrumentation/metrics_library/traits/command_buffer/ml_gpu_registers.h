...
namespace ML::XE_LP
{
    ...
    struct GpuRegistersTrait : GEN11::GpuRegistersTrait<T>
    {
        ...
        using OarCountersHigh = std::array<uint32_t, 32>;
        using NoarCounters    = std::array<uint32_t, 16>;
        using OagCountersLow  = std::array<uint32_t, 36>;
        using OagCountersHigh = std::array<uint32_t, 32>;
        using NoagCounters    = std::array<uint32_t, 16>;
        ...
        {
            return Base::GetOaCountersHigh();
        }

        //////////////////////////////////////////////////////////////////////////
        /// @brief  Returns noar counters registers.
        /// @return noar counters registers .
        //////////////////////////////////////////////////////////////////////////
        ML_INLINE static const NoarCounters& GetNoarCounters()
        {
            return Base::GetNoaCounters();
        }
        ...
        //////////////////////////////////////////////////////////////////////////
        /// @brief  Returns noag counters registers.
        /// @return noag counters registers .
        //////////////////////////////////////////////////////////////////////////
        ML_INLINE static const NoagCounters& GetNoagCounters()
        {
            static constexpr NoagCounters noagCounters =
            {
                m_OagPerfB0,
                m_OagPerfB1,
                m_OagPerfB2,
